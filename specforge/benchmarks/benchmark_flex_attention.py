...
def benchmark_function(attention_backend: str, seq_lengths: list, enable_profile: bool = False, enable_warmup: bool = False):
...
if __name__ == "__main__":
    ...
    seq_lengths = [128 * i for i in range(2, 32, 4)]
